...
(function(ab, A, B, qa, I, Wa, jb, Ra) {
  ...
  var za = ab.conpare, c = qa.userAgent, ma = qa.appVersion, Ta = Wa(ma) || 0, L = qa.platform, Oa = B.documentElement, wb = Oa && Oa.style, na = B.documentMode, r = I.width, Xa = I.height, lb, z, T, Ua, fb, oa, Ea, Ib, xa, xb, Ia, yb, Yb, Qb, Jb, pa, zb, Ja, Ab, Bb, gb, Ka, cb, Zb, Pa, mb, db, Cb, Rb, Kb, Sb, nb, X, Db, ob, Ya, Za, sb, Tb, Lb, Ub, hb, Mb, u, q, N, U, Eb, Aa, Ga, La, Ha, eb, Ma, Na, va, pb, Fb;
  ...
  if ("Nitro" === L) {
    ...
    u = 6, q = n(ma, "NintendoBrowser/"), N = 16, U = n(ma, "AppleWebKit/") || (Lb ? 536 : 534), q || (q = Lb ? 4 : 2, k(ma, "Macintosh;") || k(ma, "Windows NT") && k(ma, "Touch"));
    ...
    u = 10, q = n(c, "PLAYSTATION 3; ") || n(c, "PLAYSTATION 3 "), 0 > za(q, "4.10") && (N = 27, U = q);
    ...
    N = !Ya && (qa.standalone || (Ha || 12 > q) && kb("webkitFullscreenEnabled", B) || 11 <= q && 13 > q && qa.mediaDevices) ? 17 : 18;
    u = 24;
    U = q;
  } else if (k(c, "Kobo")) {
...
(function(ab, A, B, qa, I, Wa, jb, Ra, Ca, k, Pb, kb, n, K) {
  ...
  .9 > T, Ab = (Xa ? "ie5mac" : 5.5 > r ? "ie5win" : 6 > r ? "ie55" : 10 > r ? "ie" + (r | 0) : 7.2 > z ? "opr70" : 8 > z ? "opr72" : 9.5 > z ? "opr" + (z | 0) : T && !Ua ? 1.4 <= T ? "gck19" : 1.3 <= T ? "gck13" : 1 <= T ? "gck12" : Ja ? .8 <= T ? "gck08" : "gck07" : "gck09" : "modern") + ".css", Bb, gb, Ka, cb, Zb, Pa, mb, db, Cb, Rb, Kb, Sb, nb, X, Db, ob, Ya, Za, sb, Tb, Lb, Ub, hb, Mb, u, q, N, U, Eb, Aa, Ga, La, Ha, eb, Ma, Na, va, pb, Fb, F, ra, ka, Sa, Da, hc, Gb, $b, Hb, Nb, ub, ac, Vb, 
    ...
    eb = function(b) {
      if (N(b)) {
        if (ca) {
          ...
          return 5.5 > r && 1 === b.nodeType && (b.style.filter = ""), N(b).removeChild(b), b;
        }
      } else {
  ...
  (function() {
    ...
    if (89 <= T || 89 <= xa || pa && 79 <= Qb || D && (D("(forced-colors:none)").matches || D("(forced-colors:active)").matches)) {
      ...
      Q = function() {
        ...
        f && (t = "#123456" !== f && "rgb(18,52,86)" !== f, G = e(f) < e(g, !0), M = e(f) > e(g, !0), Ba !== h() && (Ba = h(), p("(forced-colors-fallback):" + Ba), Z(db, Ba, l)));
      };
      ub(function(e) {
        if (e) {
  ...
  (function() {
    ...
    function V(y) {
      ...
      I.fonts.load(Y).then(function(C) {
        ...
        (C = Fa(M)) ? X(v, C) : (p("[webFontTest] mesureWebFont() : false"), Z(!0));
      }, function(C) {
    ...
    function Z(y) {
      ...
      (y = Fa(M, x)) ? (p("[webFontTest] testWebFont mesurement success : " + y), v(y)) : da(x) ? (p("[webFontTest] testWebFont timeout!"), wa ? ea() : ba ? v(0) : cb !== K ? la(cb) : Cb(la)) : X(Z);
    }
    function sa() {
    ...
    function Fa(y, Y) {
      ...
      for (5 > r ? H || (H = sa()) : N(H) || Ta.appendChild(H); ya = fa[++E];) {
    ...
    function la(y) {
      ...
      y ? (wa = !0, x = aa, p("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), M = M.replace(w, ""), ea()) : v(0);
    }
    function ea() {
      var y, Y;
      if (e) {
    ...
    Kb = function(y, Y, C, E, ia, ya, ja, S) {
      ...
      W(10) ? X(v, 1) : nb ? X(v, 0) : !I.fonts || 603 > oa || 11 > Ea ? (p("[webFontTest] No native font loader."), Z(!0)) : (p("[webFontTest] Use Native font loader."), V(M));
    };
    var ba = 9 > r, P = 6 > xa || z || 530 > oa || 5 > Ea || za(10), w = "bad_" + hb() + "_", O = 5E3, aa = 500, ta = "mmmmmmmmmmlliiiiiiiii", ca = 9 <= xa && 18 > xa || 3 > Ia || 7 > Ea || oa && 0 >= A.conpare(na, "536.11"), fa = ["monospace", "sans-serif", "serif"], Qa, b, a, d, l, t, G, M, Q, e, f, g, m, x, J, R, wa, H, Va, ha;
  ...
  (function() {
    ...
    var h = 5E3, v = T && 0 > A.conpare(na, "0.9.1"), V = 11 <= r || lb || 9 <= z && 9.5 > z, da = 11 > r, Z = 7.2 <= z && 7.5 > z, sa = 9 > T && !v || 19 > xa || 4.3 > Ia || 2 > yb || 536 > oa || 6 > Ea || 7 <= z && 9 > z && !Z, Fa = !v && !V && !da && !Z && !sa, la = Fa ? function(D, ba, P) {
  ...
  (function() {
    ...
    function sa(a, d, l, t) {
      ...
      if (h) {
        ...
        g = w.indexOf(a);
        0 <= g && w.splice(g, 5);
        for (5 > r ? M(a, e) : G(a, e); f = e.shift();) {
          g = 5 > r ? f.innerText : f.data, 2 !== O ? (0 <= g.indexOf("\u2091\u208b") && (g = g.split("\u2091\u208b").join(cc)), 0 <= g.indexOf("\u1d07\u207b") && (g = g.split("\u1d07\u207b").join(cc)), O && (0 <= g.indexOf("\u208b\u2081") && (g = g.split("\u208b\u2081").join(jc)), 0 <= g.indexOf("\u1d47/\u1d04") && (g = g.split("\u1d47/\u1d04").join(qc)), 0 <= g.indexOf("\u1d47/") && (g = g.split("\u1d47/").join(oc)), 0 <= g.indexOf("/\u1d04") && (g = g.split("/\u1d04").join(pc)))) : 0 <= g.indexOf("\u2091\u208b") && 
