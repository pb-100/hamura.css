...
ua.conpare = function(Xa, A) {
  var U = 0, ja, H, Oa = (Xa + "").split("."), db = (A + "").split("."), Ma = Oa.length;
  ...
  for (H = Ma < ja ? Ma : ja; U < H; ++U) {
    var Aa = Oa[U] - 0, k = db[U] - 0;
    if (Aa !== k) {
      return Aa > k ? 1 : -1;
    }
  }
...
(function(Xa, A, U, ja, H, Oa, db, Ma) {
  ...
  function I(D) {
    for (var sa = arguments, V = 1, Pa = sa[0], Na; V < sa.length; ++V) {
      0 > ta(Pa, Na = sa[V]) && (Pa = Na);
    }
    return Pa;
  }
  function W(D) {
  ...
  var ta = Xa.conpare, c = ja.userAgent, ba = ja.appVersion, fb = Oa(ba) || 0, R = ja.platform, Ya = U.documentElement, Ia = Ya && Ya.style, m = U.documentMode, Qa = H.width;
  H = H.height;
  var gb = A.HTMLAudioElement, B = A.performance, X = A.Int8Array, hb = A.ontouchstart !== Ma, Sa = n(ba, "Version/") || n(c, "Version/"), Ga = A.operamini, ka = !Ga && A.opera, Mb = ka && (ka.version && "function" === typeof ka.version ? ka.version() : I(n(c, "Opera "), Sa, fb)), Ca = A.opr, rb = !ka && (U.all || m);
  m = rb && (m ? m : A.XMLHttpRequest ? U.getElementsByTagName ? 7 : 4 : U.compatMode ? 6 : (0).toFixed ? 5.5 : A.attachEvent ? 5 : 4);
  Ya = !rb && Ya.msContentZoomFactor;
  var Ta = !Ya && (A.chrome || A.chromium), ib = !rb && function() {
    for (var D in Ia) {
      if (0 === D.indexOf("Moz")) {
        return !0;
      }
  ...
  var sb = k(R, "Linux"), ob = "MacIntel" === R && ja.standalone !== Ma, jb = ib && n(c, "Goanna/"), wa = !jb && ib && (n(c, "rv:") || n(c.substr(c.indexOf(") Gecko/") - 11), "; ")), Xb = n(c, "Firefox/"), P = n(c, "Opera/"), Gb = A.FNRBrowser, Da = Aa(c, "AppleWebKit/"), kb = n(c, "Chrome/"), Ob = n(ba, "Iron/"), Ab = n(c, "OPR/"), Pb = n(ba, "KHTML/"), Hb = n(c.toLowerCase(), "iris");
  n(c, "FxiOS/");
  n(c, "CriOS/");
  n(c, "EdgiOS/");
  var ca = n(c, "Silk/"), lb = Aa(c, "SamsungBrowser/"), Bb = !lb && function() {
    ...
    for (V = D.length; sa = D[--V];) {
      if (k(c, sa)) {
        return Sa;
      }
    }
  }(), tb = Ta && 534.3 >= Da, mb = Lb(R), $a = mb && !k(c, R) && Lb(c);
  hb = hb && (Da || ib) && $a || !va && nb;
  ...
  var Cb = !m && U.registerElement, Qb = !m && U.execCommand, ab = A.webkitCancelAnimationFrame, Ib = sb && Cb && "11.0.696.34" === kb, ub = A._firefoxTV_playbackStateObserverJava, Rb = Aa(c, "diordnA ");
  if ("Nitro" === R) {
    var t = 1;
    ...
    if ($a) {
      ...
      if (!q || Gb) {
        q = A.PointerEvent ? 13 : A.HTMLDataListElement ? 12.2 : Array.prototype.flat ? 12 : ja.sendBeacon ? 11.3 : A.WebAssembly ? 11.2 : A.HTMLMeterElement ? 10.3 : A.Proxy ? 10.2 : A.HTMLPictureElement ? 9.3 : db.isNaN ? 9.2 : A.SharedWorker ? B && B.now ? 8 : 8.4 : Qb ? 7.1 : A.webkitURL ? 6.1 : A.Worker ? 5.1 : X ? 4.3 : gb ? 4.1 : 3.2;
      }
      var xa = Qa === 1.5 * H || 1.5 * Qa === H;
      0 === R.indexOf("iPhone") ? (Ka = 0, pa = !0) : 0 === R.indexOf("iPad") || ob ? (Ka = 1, Ea = !0) : 0 === R.indexOf("iPod") && (Ka = 2, xb = !0);
    }
    Z = !$a && (ja.standalone || (Ea || 12 > q) && eb("webkitFullscreenEnabled", U) || 11 <= q && 13 > q && ja.mediaDevices) ? 16 : 17;
    t = 24;
    F = q;
  } else if (k(c, "Kobo")) {
    ...
    t = 29, q = 18.1 > wa ? "1.0.1" : 19 > wa ? 1.1 : 27 > wa ? 1.2 : 29 > wa ? 1.3 : 31 > wa ? 1.4 : 33 > wa ? 2 : 35 > wa ? 2.1 : 38 > wa ? 2.2 : 45 > wa ? 2.5 : 2.6, k(c, "Mobile") ? pa = !0 : k(c, "Tablet") ? Ea = !0 : k(c, "TV");
    ...
    va ? xa = va : xa = {min:1.6}, q = xa, k(c, "Tablet") ? Ea = !0 : pa = !0;
  } else if (va) {
    q = va, Ja = !0;
  } else if (sb && hb || nb || mb) {
    var bb = !0;
    lb ? xa = {min:4.4} : Ta && !tb || Ca || Ab ? xa = {min:4} : (xa = va = Ia.touchAction !== Ma ? {min:5} : Cb ? 4.4 : X ? ja.connection ? A.searchBoxJavaBridge_ || Ta ? db.isNaN ? 4.1 : 4 : 4.2 : 4.4 : 534 <= Da ? 3 : 533 <= Da ? gb ? 2.3 : 2.2 : 530 <= Da ? 2 : 1.5, Bb && (Z = 24, F = Bb));
    q = xa;
    Ja = !0;
  } else {
  ...
  Z || (Fa = Fa || Ja, ka ? (Z = Fa || wb || pa || Ea ? 9 : 8, F = Mb) : rb ? (xa = Aa(ba, "Trident/") + 4, Z = wb || pa || Ea || xb ? 3 : Sb && 5 <= m ? 7 : 2, F = m) : Ya ? (Z = 23 === t ? 6 : 5, F = n(ba, "Edge/")) : jb ? (Z = 13, F = jb) : ib ? (Z = Fa ? 12 : 11, F = wa || Xb) : lb ? (Z = 24, F = lb) : (P = vb || n(c, "NetFront/")) ? (Z = 18, F = P) : (P = n(c, "iCab")) ? (Z = 19, F = P) : (P = I(n(c, "Opera Mini/"), n(c, "Opera Mobi/")) || Ga && Sa) ? (Z = 10, F = P, t || (k(c, "iPhone") ? Ka = 
  0 : k(c, "iPad") ? Ka = 1 : k(c, "iPod") && (Ka = 2), Ka && (t = 24))) : Fb ? (Z = 25, F = Nb) : Pb ? (Z = 14, F = fb) : Ja && tb ? (Z = 21, F = va) : Ta || Ca || Ab ? (Z = Fa ? 22 : 20, F = kb || Ob) : Ja && Cb ? (Z = 23, F = 5 > Oa(va) ? va : kb) : Ja && (Sa || bb) ? (Z = 21, F = va) : kb ? (Z = Fa ? 22 : 20, F = kb) : Da && (Z = 15, F = Da));
  t && (Xa[2] = t, q && (Xa[3] = W(q)));
  Z && (Xa[0] = Z, F && (Xa[1] = W(F)));
})(ua, window, document, navigator, screen, parseFloat, Number, void 0);
var yb;
(function(Xa, A, U, ja, H, Oa, db, Ma, Aa, k, Lb, eb, n, I) {
  function W(l) {
    if (A[0] === l) {
  ...
  function c(l, v, fa) {
    l + "" === l && ("a" === l.charAt(2) && (fa = !0, l = l.substr(0, 2)), l = "CS" === l ? 7.2 > B ? 117 : .9 > X || 9 > m || 9 > B || Qa ? 1 : 132 : parseInt(l, 16));
    fa && (50 === l && (l = 128), 102 < l && 108 > l && (l += 24));
    return (l - 1) * -(6 * (v || 2));
  }
  var ba = H.body, fb = ba.style, R, Ya, Ia = A[1], m = W(2) || W(3), Qa = W(7), gb = W(5) || W(6), B = W(8) || W(9), X = W(11) || W(12), hb = X && 0 <= A.conpare(Ia, "1.9.1"), Sa = W(13), Ga = W(15), ka = W(16) || W(17), Mb = W(10) || W(25), Ca = W(20) || W(22), rb = W(23), Ta = W(21), ib = W(24), Fb = Ca || rb || Ta || ib, Nb = Ca && Aa(Oa.userAgent.split("Edg/")[1]), Wb = Aa(Oa.appVersion.split("Trident/")[1]) + 4, Za = ta(35) || ta(36) || ta(37), va = ta(38) || ta(39) || ta(40) || ta(41), nb = 
  .9 > X, Ja = (Qa ? "ie5mac" : 5.5 > m ? "ie5win" : 6 > m ? "ie55" : 10 > m ? "ie" + (m | 0) : 7.2 > B ? "opr70" : 8 > B ? "opr72" : 9.5 > B ? "opr" + (B | 0) : X && !hb ? 1.4 <= X ? "gck19" : 1.3 <= X ? "gck13" : 1 <= X ? "gck12" : nb ? .8 <= X ? "gck08" : "gck07" : "gck09" : "modern") + ".css";
  ta(1) || ta(2) || ta(3) || ta(4) || ta(8) || ta(9) || ta(10);
  var sb, ob, jb, wa = 8 > m || 7.2 > B ? !1 : I, Xb = fb.transform !== I ? "transform" : fb["-o-transform"] !== I ? "-o-transform" : fb["-ms-transform"] !== I ? "-ms-transform" : fb.MozTransform !== I ? "-moz-transform" : fb["-webkit-transform"] !== I ? "-webkit-transform" : "", P = [], Gb = [], Da = [], kb, Ob, Ab, Pb, Hb = 525 > Ga || 3.1 > ka || 2.2 > Ta || 10 > B || X && !hb || W(25) || 10 > W(3) || ta(32) || ta(30) || ta(3), ca, lb, Bb, tb = [], mb = [], $a, Ua, Cb, Qb, ab = Ma.now || function() {
    return +new Ma();
  };
  (function() {
    function l() {
    ...
    Qb = oa;
    var C = [], Q = ka | 0 ? 64 : 16, J = 0, S;
    p("[core] TIMER_INTERVAL:" + Q);
    if (5 > m || Qa) {
      U._wdb_ontimer = l, l = "_wdb_ontimer()";
    }
  })();
  var Ib, ub, Rb, t, q, Z, F, vb, wb, Ka, pa, Ea, xb, xa, Ha, Fa, Sb, bb, D, sa, V, Pa;
  (function() {
    function l(a, b, d) {
      var u = ["<", a], z = 1, T, na;
      if (b) {
    ...
    Z = function(a) {
      ...
      a = b ? b : a.childNodes;
      for (var d = [], u = a.length, z = -1, T; u;) {
        if (T = a[--u], b || 1 === T.nodeType) {
          J && "FONT" === T.tagName || (d[++z] = T);
        }
      }
      return d;
    };
    ...
    Pa = function(a, b) {
      ...
      if (5.5 > m) {
        ...
        9 > B || 1 > X ? b ? a.setAttribute("style", b) : a.removeAttribute("style") : a.style.cssText = b;
      }
    };
  })();
  ...
  (function() {
    ...
    function ra(e) {
      ...
      for (; g = e[++L];) {
        g.i === this ? (this.g = g.h, m && (f.currentTarget = this), this.g(f), m ? (this.g = ja, this.g = I) : delete this.g) : 7.2 > B && this === H && g.i === U && (U.g = g.h, U.g(f), delete U.g);
      }
      if (m) {
    ...
    var S = !m && !Qa && (new db('try{var r,o=Object.defineProperty({},"passive",{get:function(){r=!0}});addEventListener("t",o,o);removeEventListener("t",o,o);return r}catch(e){}'))(), x = {}, a = !1, b = 525.13 > Ga, d = !b && !Qa && U.addEventListener, u;
    ...
    if (419.3 >= Ga) {
      var T = function() {
        if (T) {
          var e = H.readyState;
          "loaded" === e || "complete" === e ? (T = I, v()) : ca(T);
        }
      };
      ca(T);
    } else {
      Na(U, "load", v), nb && ca(function() {
        v && v();
      }, 999);
    }
    m || !nb && 1.8 > X ? Na(U, "unload", function(e) {
      oa(z, e, !0);
    }) : z = I;
    zb = function(e) {
      Gb.push(e);
    ...
    var na = 60 > X || Sa, h, K, Y;
    if (89 <= X || 89 <= Ca || Za && 79 <= Nb || C && (C("(forced-colors:none)").matches || C("(forced-colors:active)").matches)) {
    ...
    } else if (Za && (m || X && 0 <= A.conpare(Ia, "1.8.1") || Sa)) {
      var ha = function() {
        function e(g, M) {
          if (M && "transparent" === g) {
            return 382.5;
        ...
        f && (h = "#123456" !== f && "rgb(18,52,86)" !== f, K = e(f) < e(L, !0), Y = e(f) > e(L, !0), ya !== l() && (ya = l(), p("(forced-colors-fallback):" + ya), da(Da, ya, na)));
      };
      zb(function(e) {
        if (e) {
          return V(Q, "color", "#123456"), V(Q, "backgroundColor", "#123456"), na ? (ha(), Da = I) : Bb(ha), ha = I, !0;
        }
      });
    } else {
      Da = l = I;
  ...
  (function() {
    ...
    function qa(E, G) {
      ...
      if (!Va) {
        ...
        for (Va = []; ea = u[++ia];) {
          V(ma, "fontFamily", ea), Va[ia] = ma.offsetWidth;
        }
    ...
    function ra(E) {
      ...
      E ? (Ba = !0, r = a, p("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), e = e.replace(S, ""), la()) : v(0);
    }
    function la() {
      if (f) {
        for (; f.length;) {
    ...
    Gb.splice(0, 0, function() {
      if (Tb) {
        jb = 8 <= m || gb || 9.5 <= B || hb || Sa || 522 <= Ga || 3 <= ka || Mb || Fb ? 3 : 7.2 <= B ? 2 : 6 <= B || X ? 1 : 0;
        if (!jb && !m && !Qa) {
    ...
    Ab = function(E, G, w, y, aa, ia, ea) {
      ...
      W(10) ? ca(v, 1) : Hb ? ca(v, 0) : !H.fonts || 603 > Ga || 11 > ka ? (p("[webFontTest] No native font loader."), da(!0)) : (p("[webFontTest] Use Native font loader."), fa(e));
    };
    var Q = 9 > m, J = 6 > Ca || B || 530 > Ga || 5 > ka, S = "bad_" + ab() + "_", x = 5E3, a = 500, b = "mmmmmmmmmmlliiiiiiiii", d = 9 <= Ca && 18 > Ca || 3 > Ta || 7 > ka || Ga && 0 >= A.conpare(Ia, "536.11"), u = ["monospace", "sans-serif", "serif"];
    Hb || (d && Ca && p("[webFontTest] hasWebKitFallbackBug : p_Chromium=" + Ca), d && ka && p("[webFontTest] hasWebKitFallbackBug : p_SafariMobile=" + ka), d && Ga && p("[webFontTest] hasWebKitFallbackBug : p_WebKit=" + Ga));
    var z = 14 <= gb || 36 <= Ca || 39 <= X || 602 <= Ga && va && 0 <= A.conpare("10.12", va) || 10 <= ka, T = 6 <= Ca || X && 0 <= A.conpare(Ia, "1.9.2") || 533 <= Ga || 5 <= ka || 4.4 <= Ta || 11.5 <= B || gb || 9 <= W(2) || 10 <= W(3), na = 2 <= Ca || hb || 525 <= Ga || 4 <= ka || 2.2 <= Ta || 10.1 <= B || gb || 9 <= W(2) || 10 <= W(3), h = na, K = 5.1 <= Za && 5.2 >= Za && 40 > Ca || 6 <= Za && 6.1 > Za && 51 > Ca || 37 > Ca || 525 <= Ga || 3.1 <= ka || 3 <= Ta || 11.5 <= B, Y = 4 <= W(2) || 
    10 <= W(3), ha, e, f, L, g, M, r, O, Ba, ma, za, Va;
  })();
  (function() {
    Pb = function(C, Q, J, S) {
    ...
    var l = X && 0 > A.conpare(Ia, "0.9.1"), v = 11 <= m || gb || 9 <= B && 9.5 > B, fa = 11 > m, oa = 7.2 <= B && 7.5 > B, da = 9 > X && !l || 19 > Ca || 4.3 > Ta || 2 > ib || 536 > Ga || 6 > ka || 7 <= B && 9 > B && !oa, qa = !l && !v && !fa && !oa && !da, ra = qa ? function(C, Q, J) {
  ...
  Vb(8194);
  var fc = cb[31], ac = cb[30], gc = cb[63], kc = cb[125], lc = cb[126], mc = Vb(59648), hc = (9 === m || X && 0 <= A.conpare(Ia, "1.8.1") || Sa) && !Ub, pb = [], qb, Wa, Kb = 7.2 > B ? function() {
    qb = !qb;
    for (var l = -1, v; v = pb[++l];) {
      -1 !== v.className.indexOf("pbAlp") ? V(v, "display", qb ? "" : "none") : (D(v, qb ? "pbChrCS" : "pbChr00"), sa(v, qb ? "pbChr00" : "pbChrCS"));
    }
  } : hc ? function() {
    qb = !qb;
    for (var l = -1, v; v = pb[++l];) {
  ...
  (function() {
    ...
    function ra(h, K) {
      ...
      for (Ba = h.length; O < Ba; ++O) {
        ...
        if ("\n" !== r) {
          ...
          G = I;
          aa ? (r = 6 <= m && 8 > m ? " " : ec, y = "") : ia && (X && !hb || 9.5 > B) ? (ia && !ma && (za = 4 - (Aa(h.substr(O)) + "").length), 7.5 > B ? G = z ? "position:relative;top:-4px;left:" + 12 * za + "px" : {position:"relative", top:"-4px", left:12 * za + "px"} : G = z ? "position:relative;left:" + 12 * za + "px" : {position:"relative", left:12 * za + "px"}) : w && 7.5 > B && (y = "pbList-strsp");
      ...
      if (L) {
        z ? K.innerHTML = g.join("") : na && E.appendChild(K), T && V(K, "visibility", Va);
      } else {
        if (z) {
    ...
    1.9 > X && zb(function(h) {
      if (h) {
        ...
        for (var K = 0, Y = h.length, ha; K < Y; ++K) {
          ha = h[K], "B" !== Ea(ha) && -1 !== (" " + ha.className).toLowerCase().indexOf(" pbchr") && (Fa(ha, "title") || xa(ha, "title", ha.textContent), ha.textContent = " ");
        }
        return !0;
      }
    });
    ...
    var la = [], C = X && 0 > A.conpare(Ia, "0.9.9");
    zb(function(h) {
      function K(w) {
        var y = xb(w, "pbTip");
        if (y) {
          ...
          g ? F(w, "div", {style:{left:7 * y + 3 + "px"}}) : (aa = xb(w, "title"), Ha(w, "pbTip"), Ha(w, "title"), ia = F(w, "div", {className:"pbTip" + (ia ? "Btm" : ""), style:{width:aa.length + ha + "em", left:7 * y - (C ? 0 : 5) + "px"}}, aa), ia = F(ia, "div"), .9 <= X && C && V(ia, "left", "2px"));
        }
      ...
      function Y(w, y) {
        ...
        ea = ea.split(" ")[0];
        if (N = Aa(N.split(" ")[0])) {
          e && (ia = ia.split("pbChr")[1].split(" ")[0], V(w, "backgroundPosition", c(ia, 2, Va) + "px " + -24 * (10 - N) + "px")), !y && f && vb(w, "a").appendChild(w);
        }
        aa && (N = 10 - N, e && (Eb = {backgroundPosition:c(aa, 2, Va) + "px " + -24 * (10 - N) + "px"}), Ha(w, "pbGhst"), O = vb(w, "b", {className:"pbChr" + aa + " pbCsr" + ea + " pbAlp" + N, style:Eb}, La), bc(O));
        bc(w);
      }
      if (h) {
        var ha = 6 > m ? 2 : 0, e = 7.2 > B || .9 > X || Qa, f = 1.1 === X, L = 1.4 > X;
        h = ub("SAMP");
        ...
        if (h.length) {
          for (Ba = -1; r = h[++Ba];) {
            if (bb(t(r), "pbLCD")) {
              var Va = bb(r, "PB-120") || bb(r, "FX-795P");
              var E = Z(r);
    ...
    var z = !1, T = 8 > B, na = !z && !T && !(6 > m) && H.createDocumentFragment && !!ba.replaceChild;
    Xa.prettify = qa;
  })();
  ...
  Db(function() {
    ...
    }, U.onerror = function(v, fa, oa) {
      yb(v + ", " + fa + ", " + oa);
      return !0;
    }) : U.console ? (p = console.log, yb = console.error) : B ? (p = ja, yb = opera.postError) : p = yb = ja;
    for (; tb.length;) {
      p(tb.shift());
    }
    for (; mb.length;) {
  ...
  6.1 > ka && Na(U, "scroll", $a);
  Jb(Ua);
  6.1 > ka && Na(U, "scroll", Cb);
  Jb(Qb);
  10 > m && (11 !== Wb || 5 !== m) || (9 > B || 1 > X || !Qa && !U.addEventListener ? H.write('<link href="' + Ra + Ja + '" rel="stylesheet"' + (8 > B ? "" : ' media="screen,handheld,projection,print"') + ">") : Db(function() {
    F(Ya, "link", {href:Ra + "" + Ja, rel:"stylesheet", media:"screen,handheld,projection,tv,print"});
  }));
