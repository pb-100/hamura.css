...
(function(Wa, C, U, ja, H, La, fb, Ka) {
  ...
  H = H.height;
  var ib = C.HTMLAudioElement, A = C.performance, W = C.Int8Array, jb = C.ontouchstart !== Ka, Qa = n(Z, "Version/") || n(c, "Version/"), Da = C.operamini, la = !Da && C.opera, Rb = la && (la.version && "function" === typeof la.version ? la.version() : O(n(c, "Opera "), Qa, hb)), Ia = C.opr, ub = !la && (U.all || m);
...
var Cb;
(function(Wa, C, U, ja, H, La, fb, Ka, xa, k, Qb, gb, n, O) {
  function V(l) {
    if (C[0] === l) {
  ...
  (function() {
    ...
    function sa(e) {
      ...
      for (; g = e[++K];) {
        g.i === this ? (this.g = g.h, m && (f.currentTarget = this), this.g(f), m ? (this.g = ja, this.g = O) : delete this.g) : 7.2 > A && this === H && g.i === U && (U.g = g.h, U.g(f), delete U.g);
      }
      if (m) {
    ...
    Ca = function(e, f, K, g) {
      if (d) {
        e.addEventListener(f, K, g ? S ? g : g.capture || !0 === g : !1);
      } else {
        var L = {i:e, h:K};
        g = x[f];
        var r = "on" + f, N, Aa;
    ...
    Xa = function(e, f, K, g) {
      if (d) {
        e.removeEventListener(f, K, g ? S ? g : g.capture || !0 === g : !1);
      } else {
        g = x[f];
        f = "on" + f;
        var L, r, N;
    ...
    if (419.3 >= Da) {
      var T = function() {
        if (T) {
          var e = H.readyState;
          "loaded" === e || "complete" === e ? (T = O, v()) : ba(T);
        }
      };
      ba(T);
    } else {
  ...
  (function() {
    ...
    var Q = 9 > m, I = 6 > Ia || A || 530 > Da || 4 > la, S = "bad_" + bb() + "_", x = 5E3, a = 500, b = "mmmmmmmmmmlliiiiiiiii", d = 21 > Ia || 7 > la || Da && 0 >= C.conpare(Ha, "536.11"), u = ["monospace", "sans-serif", "serif"];
    ...
    var y = 14 <= ib || 36 <= Ia || 39 <= W || 602 <= Da || 10 <= la, T = 6 <= Ia || W && 0 <= C.conpare(Ha, "1.9.2") || 525 <= Da || 3.2 <= la || 4.4 <= Za || 11.1 <= A || ib || 9 <= V(2) || 10 <= V(3), oa = 2 <= Ia || jb || 525 <= Da || 3.2 <= la || 2.2 <= Za || 10 <= A || ib || 9 <= V(2) || 10 <= V(3), h = oa, J = 525 <= Da || 3.2 <= la || 38 > Ia || 3 <= Za || 11.5 <= A, X = 4 <= V(2) || 10 <= V(3), ha, e, f, K, g, L, r, N, Aa, ma, wa, Ua;
  })();
  (function() {
    Kb = function(B, Q, I, S) {
    ...
    var l = W && 0 > C.conpare(Ha, "0.9.1"), v = 11 <= m || ib || 9 <= A && 9.5 > A, fa = 11 > m, pa = 7.2 <= A && 7.5 > A, da = 9 > W && !l || 19 > Ia || 4.3 > Za || 2 > kb || 536 > Da || 6 > la || 7 <= A && 9 > A && !pa, ra = !l && !v && !fa && !pa && !da, sa = ra ? function(B, Q, I) {
  ...
  Wb(8194);
  var ec = eb[31], Xb = eb[30], ic = eb[63], jc = eb[125], kc = eb[126], lc = Wb(59648), fc = (9 === m || W && 0 <= C.conpare(Ha, "1.8.1") || Qa) && !Vb, sb = [], tb, Va, Pb = 7.2 > A ? function() {
    tb = !tb;
  ...
  (function() {
    ...
    function sa(h, J) {
      ...
      for (Aa = h.length; N < Aa; ++N) {
        ...
        if ("\n" !== r) {
          ...
          G = O;
          aa ? (r = 6 <= m && 8 > m ? " " : dc, z = "") : ia && (W && !jb || 9.5 > A) ? (ia && !ma && (wa = 4 - (xa(h.substr(N)) + "").length), 7.5 > A ? G = y ? "position:relative;top:-4px;left:" + 12 * wa + "px" : {position:"relative", top:"-4px", left:12 * wa + "px"} : G = y ? "position:relative;left:" + 12 * wa + "px" : {position:"relative", left:12 * wa + "px"}) : w && 7.5 > A && (z = "pbList-strsp");
      ...
      if (K) {
        y ? J.innerHTML = g.join("") : oa && D.appendChild(J), T && ca(J, "visibility", Ua);
      } else {
        if (y) {
    ...
    Db(function(h) {
      ...
      if (h) {
        var ha = 6 > m ? 2 : 0, e = 7.2 > A || .9 > W || Ma, f = 1.1 === W, K = 1.4 > W;
        h = Ab("SAMP");
  ...
  Ob(Eb);
  10 > m && (11 !== Yb || 5 !== m) || (9 > A || 1 > W || !Ma && !U.addEventListener ? H.write('<link href="' + Pa + wb + '" rel="stylesheet"' + (8 > A ? "" : ' media="screen,handheld,projection,print"') + ">") : Gb(function() {
