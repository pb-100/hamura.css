...
(function(ab, B, C, qa, I, Wa, jb, Sa) {
  ...
  var wa = ab.conpare, c = qa.userAgent, ma = qa.appVersion, Ua = Wa(ma) || 0, K = qa.platform, Pa = C.documentElement, wb = Pa && Pa.style, na = C.documentMode, q = I.width, Xa = I.height, lb, A, S, Va, gb, oa, Ea, Ib, va, xb, Ia, yb, Yb, Qb, Jb, pa, zb, Ja, Ab, Bb, cb, Ka, db, Zb, Qa, mb, eb, Cb, Rb, Kb, Sb, nb, X, Db, ob, Ya, Za, sb, Tb, Lb, Ub, hb, Mb, v, r, O, T, Eb, xa, Ga, La, Ha, fb, Ma, Na, ta, pb, Fb;
  ...
  if ("Nitro" === K) {
    ...
    v = 2, r = Ea, O = 9, T = r;
  } else if ("New Nintendo 3DS" === K || l(c, "iPhone OS 6_0") && 320 === q && 240 === Xa) {
    ...
    Fb = !0;
    nb ? Ma = {min:4.4} : xb && !Db || Ib || Cb ? Ma = {min:4} : (Ma = pa = wb.touchAction !== Sa ? {min:5} : Za ? 4.4 : A ? qa.connection ? B.searchBoxJavaBridge_ || xb ? jb.isNaN ? 4.1 : 4 : 4.2 : 4.4 : 534 <= Qa ? 3 : 533 <= Qa ? I ? 2.3 : 2.2 : 530 <= Qa ? 2 : 1.5, X && (O = 25, T = X));
    r = Ma;
    Ja = !0;
  } else {
...
(function(ab, B, C, qa, I, Wa, jb, Sa, Aa, l, Pb, kb, n, J) {
  ...
  function ma(h, w, U) {
    h + "" === h && ("a" === h.charAt(2) && (U = !0, h = h.substr(0, 2)), h = "CS" === h ? 7.2 > A ? 117 : .9 > S || 9 > q || 9 > A || Xa ? 1 : 132 : parseInt(h, 16));
    U && (50 === h && (h = 128), 102 < h && 108 > h && (h += 24));
    return (h - 1) * -(6 * (w || 2));
  }
  var Ua = I.body, K = Ua.style, Pa, wb, na = B[1], q = W(2) || W(3), Xa = W(7), lb = W(5) || W(6), A = W(8) || W(9), S = W(11) || W(12), Va = S && 0 <= B.conpare(na, "1.9.1"), gb = W(13), oa = W(16), Ea = W(17) || W(18), Ib = W(10) || W(26), va = W(21) || W(23), xb = W(24), Ia = W(22), yb = W(25), Yb = va || xb || Ia || yb, Qb = va && Aa(Wa.userAgent.split("Edg/")[1]), Jb = Aa(Wa.appVersion.split("Trident/")[1]) + 4, pa = wa(37) || wa(38) || wa(39), zb = wa(40) || wa(41) || wa(42) || wa(43), Ja = 
  .9 > S, Ab = (Xa ? "ie5mac" : 5.5 > q ? "ie5win" : 6 > q ? "ie55" : 10 > q ? "ie" + (q | 0) : 7.2 > A ? "opr70" : 8 > A ? "opr72" : 9.5 > A ? "opr" + (A | 0) : S && !Va ? 1.4 <= S ? "gck19" : 1.3 <= S ? "gck13" : 1 <= S ? "gck12" : Ja ? .8 <= S ? "gck08" : "gck07" : "gck09" : "modern") + ".css", Bb, cb, Ka, db, Zb, Qa, mb, eb, Cb, Rb, Kb, Sb, nb, X, Db, ob, Ya, Za, sb, Tb, Lb, Ub, hb, Mb, v, r, O, T, Eb, xa, Ga, La, Ha, fb, Ma, Na, ta, pb, Fb, F, la, fa, Ta, Ba, hc, Gb, $b, Hb, Nb, ub, ac, Vb, 
  ...
  (function() {
    ...
    function U(b) {
      var a = "*" === b;
      b = da ? a ? I.all : I.all.tags(b.toUpperCase()) : 6 > q && a ? I.all : I.getElementsByTagName(b);
      a = [];
    ...
    r = function(b) {
      ...
      if (9 > q || !I.getElementsByClassName) {
        G = 6 > q ? I.all : I.getElementsByTagName("*");
      } else {
        N = !0;
    ...
    xa = function(b, a, d, k, u) {
      a = Y(2, b, a, d, k, u);
      da || (b.appendChild(a), Ra && null != k && (9 > q ? ra(a, k) : Fa(a, k)));
      return a;
    };
    Ga = function(b, a, d, k, u) {
      a = Y(0, b, a, d, k, u);
      da || (ha(b).insertBefore(a, b), Ra && null != k && (9 > q ? ra(a, k) : Fa(a, k)));
      return a;
    };
    La = ra;
    Ha = function(b, a) {
    ...
    fb = function(b) {
      if (O(b)) {
        if (da) {
          ...
          return 5.5 > q && 1 === b.nodeType && (b.style.filter = ""), O(b).removeChild(b), b;
        }
      } else {
  ...
  (function() {
      ...
      if (da) {
        ...
        if (m) {
          if (ja) {
            ...
            R || (ba ? f.detachEvent(y, ka) : q ? (f[y] = qa, f[y] = null) : delete f[y]);
          }
        }
      }
    }
    function ka(f) {
      ...
      for (; m < y; m += 2) {
        ...
        if (R === this) {
          Q = f[m + 1];
          5.5 > q ? (R[g] = Q, R[g](e), R[g] = ka) : Q.call(R, e);
        } else {
    ...
    function ia() {
      ...
      Vb !== f && (Y(mb, Vb = f), p("p_cssAvailability:" + Vb));
    }
    ...
    $b = Fa;
    x = !q && !Xa && (new jb('try{var r,o=Object.defineProperty({},"passive",{get:function(){r=!0}});addEventListener("t",o,o);removeEventListener("t",o,o);return r}catch(e){}'))();
    M = {};
    ba = !1;
    sa = 525.13 > oa;
    ...
    } else if (10 <= q || lb || pa && Qb) {
      Wb = !0, U("(-ms-high-contrast:black-on-white)", function(f) {
        u = G = f.matches;
        ya !== h() && (ya = h(), Y(eb, ya), p("(-ms-high-contrast:black-on-white):" + ya));
      }), U("(-ms-high-contrast:white-on-black)", function(f) {
        u = N = f.matches;
        ya !== h() && (ya = h(), Y(eb, ya), p("(-ms-high-contrast:white-on-black):" + ya));
      }), U("(-ms-high-contrast:active)", function(f) {
        u = f.matches;
        ya !== h() && (ya = h(), Y(eb, ya), p("(-ms-high-contrast:active):" + ya));
      });
    } else if (pa && (q || S && 0 <= B.conpare(na, "1.8.1") || gb)) {
      L = function() {
        function f(m, y) {
          var H;
          if (y && "transparent" === m) {
        ...
        e && (u = "#123456" !== e && "rgb(18,52,86)" !== e, G = f(e) < f(g, !0), N = f(e) > f(g, !0), ya !== h() && (ya = h(), p("(forced-colors-fallback):" + ya), Y(eb, ya, k)));
      };
      ub(function(f) {
        if (f) {
  ...
  (function() {
    ...
    function U(t) {
      ...
      I.fonts.load(ea).then(function(z) {
        p("[webFontTest] fonts.check() : " + I.fonts.check(ea, "i") + ", fonts.length : " + z.length);
        (z = Fa(N)) ? X(w, z) : (p("[webFontTest] mesureWebFont() : false"), Y(!0));
      }, function(z) {
        p("[webFontTest] fonts.load() rejected! " + z);
        db !== J ? ka(db) : Cb(ka);
      });
    }
    function ha(t) {
    ...
    function Y(t) {
      t && (p("[webFontTest] testWebFont start."), H = hb());
      (t = Fa(N, m)) ? (p("[webFontTest] testWebFont mesurement success : " + t), w(t)) : ha(m) ? (p("[webFontTest] testWebFont timeout!"), R ? ia() : ca ? w(0) : db !== J ? ka(db) : Cb(ka)) : X(Y);
    }
    function ra() {
      return xa(Ua, 5 > q ? "div" : "span", {"aria-hidden":"true", style:{position:"absolute", top:0, left:0, visibility:"hidden", fontSize:"72px", "-webkit-font-feature-settings":'"liga"', "-moz-font-feature-settings":15 > S ? '"liga=1"' : '"liga"', "-ms-font-feature-settings":'"liga" 1', "-o-font-feature-settings":'"liga"', "font-feature-settings":'"liga"'}}, sa);
    }
    function Fa(t, ea) {
      ...
      if (!Oa) {
        ...
        p("[webFontTest] default width " + Oa.join(", "));
      }
      for (5 > q ? Q || (Q = ra()) : O(Q) || Ua.appendChild(Q); Ca = ja[++E];) {
        Ba(Q, "fontFamily", '"' + t + '",' + Ca);
        V = Q.offsetWidth;
        da ? aa[E] = V : (aa[E] = V, V !== Oa[E] && (z = 9 > q ? V ? 1 : 0 : 1));
      }
      if (da && V === aa[0] && V === aa[1]) {
        for (p("[webFontTest] Hit... : width=" + V), z = 1, E = -1; 0 <= (V = Oa[++E]);) {
          if (V === aa[0] && V === aa[1] && V === aa[2]) {
            p("[webFontTest] Failed! : font[" + E + "]=" + ja[E]);
            z = 0;
            break;
          }
        }
      }
      !q && z && e && (Q.textContent = e, V = Q.offsetWidth, Q.textContent = g, z = V === Q.offsetWidth ? 2 : 1, Q.textContent = sa);
      Q = fb(Q);
      ea && (z || ha(ea)) && p("[webFontTest] " + t + " " + aa.join(", "));
      return z;
    }
    function ka(t) {
      p("[webFontTest] onTestDataURIComplete : " + t);
      t ? (R = !0, m = ba, p("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), N = N.replace(x, ""), ia()) : w(0);
    }
    function ia() {
      var t, ea;
      if (L) {
        for (; L.length;) {
          ...
          ea = L.shift();
          if (h(t)) {
            p("[webFontTest] maybe can use! " + ea);
            Z = Sb(ea, D, f, Z, y);
            return;
          }
        }
    ...
    mb.splice(0, 0, function() {
      var t;
      if (Vb) {
        Ka = 8 <= q || lb || 9.5 <= A || Va || gb || 522 <= oa || 3 <= Ea || Ib || Yb ? 3 : 7.2 <= A ? 2 : 6 <= A || S ? 1 : 0;
        if (!Ka && !q && !Xa) {
    ...
    Cb = !1 === db ? function(t) {
      ...
      if (db !== J) {
        p("[dataURITest] already done : " + db), X(t, db);
      } else {
        p("[dataURITest] start!");
        z = new Image();
        E = X(ea, !1, 99);
        ...
        z.onload = function() {
          p("[dataURITest] DATA URI:" + (1 === z.width * z.height));
    ...
    Kb = function(t, ea, z, E, aa, Ca, za) {
      ...
      W(10) ? X(w, 1) : nb ? X(w, 0) : !I.fonts || 603 > oa || 11 > Ea ? (p("[webFontTest] No native font loader."), Y(!0)) : (p("[webFontTest] Use Native font loader."), U(N));
    };
    var ca = 9 > q, P = 6 > va || A || 530 > oa || 5 > Ea || wa(10), x = "bad_" + hb() + "_", M = 5E3, ba = 500, sa = "mmmmmmmmmmlliiiiiiiii", da = 9 <= va && 18 > va || 3 > Ia || 7 > Ea || oa && 0 >= B.conpare(na, "536.11"), ja = ["monospace", "sans-serif", "serif"], Ra, b, a, d, k, u, G, N, L, f, e, g, m, y, H, R, Q, Z, Oa;
    nb || (da && va && p("[webFontTest] hasWebKitFallbackBug : p_Chromium=" + va), da && Ea && p("[webFontTest] hasWebKitFallbackBug : p_SafariMobile=" + Ea), da && oa && p("[webFontTest] hasWebKitFallbackBug : p_WebKit=" + oa), da && Ia && p("[webFontTest] hasWebKitFallbackBug : p_AOSP=" + Ia));
  ...
  (function() {
    Sb = function(D, ca, P, x, M) {
      var ba, sa, da;
      if (w) {
        p("[CSS Loader] UNSUPPORTED"), X(ca, !1);
      } else {
        if (x) {
          if (va && x.href) {
            sa = x.cloneNode();
        ...
        if (!Fa) {
          ...
          da = ba.offsetWidth;
          p("[CSS Loader] widthBeforeCSSLoaded = " + da);
          ta(ba, "id", P);
        }
    ...
    var h = 5E3, w = S && 0 > B.conpare(na, "0.9.1"), U = 11 <= q || lb || 9 <= A && 9.5 > A, ha = 11 > q, Y = 7.2 <= A && 7.5 > A, ra = 9 > S && !w || 19 > va || 4.3 > Ia || 2 > yb || 536 > oa || 6 > Ea || 7 <= A && 9 > A && !Y, Fa = !w && !U && !ha && !Y && !ra, ka = Fa ? function(D, ca, P) {
      ...
      function j() {
        if ("loaded" === D.readyState || "complete" === D.readyState) {
          X(P, ia(x, M)), x = J, D.onreadystatechange = qa;
        }
      }
      j = !1;
    } : ra || Y ? function(D, ca, P, x, M, ba) {
      function sa() {
        ja && (Ra = Db(Ra), p("[CSS Loader] onComplete"), b = hb() + 999, X(da, 0, 99), ra ? ja.onerror = null : ja.removeEventListener("load", sa, !1), ja = J);
      }
      function da() {
        ia(x, M) ? (X(P, !0), x = P = J) : hb() < b ? X(da, 0, 99) : (X(P, !1), x = P = J);
      }
      var ja = new Image(), Ra = X(sa, 0, ba), b;
      ra ? (p("[CSS Loader] img.onerror + mesure"), ja.onerror = sa) : (p('[CSS Loader] img.addEventListener("load") + mesure'), ja.addEventListener("load", sa, !1));
      ja.src = D.href = ca;
  ...
  pc = ib[126];
  qc = Xb(59648);
  kc = (9 === q || S && 0 <= B.conpare(na, "1.8.1") || gb) && !Wb;
  qb = [];
  Ob = 7.2 > A ? function() {
    rb = !rb;
  ...
  Wb || ac(function(h) {
    h ? (ta(Pa, "forced-colors", 2 === h ? "lod" : 3 === h ? "dol" : "active"), (Zb || 9 === q || 5.5 <= q && 9 > q && Bb) && fa(Pa, "jsCanRotate")) : (pb(Pa, "forced-colors"), Ta(Pa, "jsCanRotate"));
  });
  (function() {
    function h() {
      var a, d;
      h = J;
      x.length ? (ra(a = x.shift(), x.shift(), x.shift(), x.shift()), (d = x.shift()) && X(d, a)) : p("[pbList] complete.");
    }
    function w(a) {
      a ? (p("[pbList] Fallback start!"), fa(Ua, "pbList-noWebFont")) : p("[pbList] image disabled!");
      h();
    }
    function U(a) {
      M = a;
      p("[pbList] WebFont test result : " + !!a);
      a ? h() : cb ? w(!0) : cb !== J ? h() : (p("[pbList] Need imageTest " + ba), Rb(w, ba));
    ...
    function ra(a, d, k, u) {
      ...
      if (h) {
        ...
        for (5 > q ? N(a, f) : G(a, f); e = f.shift();) {
          g = 5 > q ? e.innerText : e.data, 2 !== M ? (0 <= g.indexOf("\u2091\u208b") && (g = g.split("\u2091\u208b").join(cc)), 0 <= g.indexOf("\u1d07\u207b") && (g = g.split("\u1d07\u207b").join(cc)), M && (0 <= g.indexOf("\u208b\u2081") && (g = g.split("\u208b\u2081").join(jc)), 0 <= g.indexOf("\u1d47/\u1d04") && (g = g.split("\u1d47/\u1d04").join(qc)), 0 <= g.indexOf("\u1d47/") && (g = g.split("\u1d47/").join(oc)), 0 <= g.indexOf("/\u1d04") && (g = g.split("/\u1d04").join(pc)))) : 0 <= g.indexOf("\u2091\u208b") && 
          (g = g.split("\u2091\u208b").join("\u1d07\u207b")), 0 <= g.indexOf("\u2091") && (g = g.split("\u2091").join(ic)), !d || !k && cb ? Fa(g.split("\r\n").join("\n").split("\r").join("\n").split("&yen;").join(mc).split("&lt;").join("<").split("&gt;").join(">").split("&quot;").join(bc).split("&amp;").join("&"), e, d, k) : 5 > q ? e.innerText = g : e.data = g;
        }
        u && X(u, a);
      }
    }
    function Fa(a, d, k, u) {
      ...
      var f = " area line str cmd fnc syb".split(" "), e = 5 > q || 1 === d.nodeType, g = [], m = "", y, H = -1, R, Q, Z, Oa, t, ea, z, E, aa, Ca, za;
      if (e) {
        if (Ra) {
      ...
      for (R = a.length; H < R; ++H) {
        ...
        if ("\n" !== y) {
          ...
          z = J;
          Ca ? (y = " ", Z = "") : za && (S && !Va || 9.5 > A) ? (za && !Q && (Oa = 4 - (Aa(a.substr(H)) + "").length), 7.5 > A ? z = ja ? "position:relative;top:-4px;left:" + 12 * Oa + "px" : {position:"relative", top:"-4px", left:12 * Oa + "px"} : z = ja ? "position:relative;left:" + 12 * Oa + "px" : {position:"relative", left:12 * Oa + "px"}) : E && 7.5 > A && (Z = "pbList-strsp");
    ...
    ub(function(a) {
      ...
      function k(t, ea) {
        ...
        z && (Ca = 10 - Ca, G && (V = {backgroundPosition:ma(z, 2, Q) + "px " + -24 * (10 - Ca) + "px"}), pb(t, "pbGhst"), m = Ga(t, "b", {className:"pbChr" + z + " pbCsr" + aa + " pbAlp" + Ca, style:V}, za), dc(m));
        dc(t);
      }
      if (a) {
        u = 6 > q ? 2 : 0;
    ...
    6 === q && (new jb("d", 'try{d.execCommand( "BackgroundImageCache",!1,!0)}catch(_){}'))(I);
    ...
    ub(function(a) {
      ...
      if (a) {
        ...
        x.length && (p("[pbList] " + x.length / 5 + " elements found. WebFont test start."), ha());
        return !0;
      }
    });
    ja = !1;
    Ra = 8 > A;
    b = !ja && !Ra && !(6 > q) && I.createDocumentFragment && !!Ua.replaceChild;
    ab.prettify = ra;
  ...
  Hb(function() {
    ...
    h ? (p = j, tb = function(w) {
      ...
      tb(w + ", " + U + ", " + ha);
      return !0;
    }) : C.console ? (p = console.log, tb = console.error) : A ? (p = qa, tb = opera.postError) : p = tb = qa;
    for (; Ya.length;) {
      p(Ya.shift());
    }
    for (; Za.length;) {
  ...
  Nb(Ub);
  10 > q && (11 !== Jb || 5 !== q) || (9 > A || 1 > S || !Xa && !C.addEventListener ? I.write('<link href="' + $a + Ab + '" rel="stylesheet"' + (8 > A ? "" : ' media="screen,handheld,projection,print"') + ">") : Hb(function() {
