...
(function(Ya, A, y, ia, J, Sa, gb, Na, ya, k, Nb, hb, m, K) {
        ...
        for (H in b) {
          ...
          if (null != ca && "" !== ca) {
            if ("style" === H) {
              v[++C] = ' style="';
              for (qa in ca) {
                for (var r = ++C, D, da = [], ma = qa.split(""), g = ma.length; g;) {
                  D = ma[--g], "A" <= D && "Z" >= D && (D = "-" + D.toLowerCase()), da[g] = D;
                }
                v[r] = da.join("") + ":" + ca[qa] + ";";
              }
              v[++C] = '"';
  ...
  (function() {
    ...
    function Ca(g) {
      ...
      g = a[e.type];
      var E = -1, f, I;
      5 > q ? e = {type:event.type, target:event.srcElement, preventDefault:o, stopPropagation:function() {
        event.cancelBubble = !0;
      }} : q ? (e.target = e.srcElement, e.preventDefault = function() {
        e.returnValue = !1;
      }, e.stopPropagation = function() {
        e.cancelBubble = !0;
      }) : d && (e.j = e.stopPropagation, e.stopPropagation = function() {
        I = !0;
      });
      for (; f = g[++E];) {
        f.i === this ? (this.g = f.h, q && (e.currentTarget = this), this.g(e), q ? (this.g = ia, this.g = K) : delete this.g) : 7.2 > B && this === J && f.i === y && (y.g = f.h, y.g(e), delete y.g);
      }
      if (q) {
        return e.preventDefault = e.stopPropagation = ia, e.preventDefault = e.stopPropagation = K, e.returnValue;
      }
      d && (e.defaultPrevented && "click" === e.type && "A" === e.target.tagName && (C = !0), I && !C && e.j(), e.j = e.stopPropagation = K);
      function o() {
        event.returnValue = !1;
      }
      o = !1;
    ...
    function fa() {
      var g = 9 === G.offsetWidth;
      Tb !== g && (aa(kb, Tb = g), n("p_cssAvailability:" + Tb));
    }
    ...
    Db = function(g, e, E, f) {
      if (v) {
        g.addEventListener(e, E, f ? U ? f : f.capture || !0 === f : !1);
      } else {
        var I = {i:g, h:E};
        f = a[e];
        var w = "on" + e, N, Aa;
        if (f) {
          ...
          a[e] = f = [I], b || (e = g[w], "function" === typeof e && e !== Ca && f.unshift({i:g, h:e}));
        }
        b ? g.attachEvent(w, Ca) : g[w] = Ca;
      }
    };
    Yb = function(g, e, E, f) {
      if (v) {
        g.removeEventListener(e, E, f ? U ? f : f.capture || !0 === f : !1);
      } else {
        f = a[e];
        e = "on" + e;
        var I, w, N;
        if (f) {
          for (I = f.length; w = f[--I];) {
            w.i === g && (w.h === E ? f.splice(I, 1) : N = !0);
          }
          N || (b ? g.detachEvent(e, Ca) : q ? (g[e] = ia, g[e] = null) : delete g[e]);
        }
      }
    };
    ...
    d && Ka.addEventListener("click", function(g) {
      if (C) {
        return C = !1, g.preventDefault(), !1;
      }
    });
    Eb = function(g) {
      La ? La.push(g) : alert("Load event has already been dispatched!");
    };
    Lb = function(g) {
      H && H.push(g);
    };
    ...
    if (419.3 >= oa) {
      var qa = function() {
        if (qa) {
          var g = J.readyState;
          "loaded" === g || "complete" === g ? (qa = K, t()) : Y(qa);
        }
      };
      Y(qa);
    } else {
    ...
    q || !Ga && 1.8 > S ? Db(y, "unload", function(g) {
      sa(H, g, !0);
    }) : H = K;
    tb = function(g) {
      kb.push(g);
    ...
    if (89 <= S || 89 <= ra || la && 79 <= Ob || z && (z("(forced-colors:none)").matches || z("(forced-colors:active)").matches)) {
      Ub = !0, Z("(forced-colors:active)", function(g) {
        r = g.matches;
        xa = h();
        aa($a, xa);
      ...
      Ub = !0, Z("(-ms-high-contrast:black-on-white)", function(g) {
        r = D = g.matches;
        xa !== h() && (xa = h(), aa($a, xa), n("(-ms-high-contrast:black-on-white):" + xa));
      }), Z("(-ms-high-contrast:white-on-black)", function(g) {
        r = da = g.matches;
        xa !== h() && (xa = h(), aa($a, xa), n("(-ms-high-contrast:white-on-black):" + xa));
      }), Z("(-ms-high-contrast:active)", function(g) {
        r = g.matches;
      ...
      var ma = function() {
        ...
        var e = J.defaultView;
        var E = e ? e.getComputedStyle(G, null) : G.currentStyle;
        e = (E && E.color || "").split(" ").join("");
        E = (E && E.backgroundColor || "").split(" ").join("");
        e && (r = "#123456" !== e && "rgb(18,52,86)" !== e, D = g(e) < g(E, !0), da = g(e) > g(E, !0), xa !== h() && (xa = h(), n("(forced-colors-fallback):" + xa), aa($a, xa, ca)));
      };
      tb(function(g) {
        if (g) {
  ...
  (function() {
    ...
    function Z(l) {
      ...
      J.fonts.load(M).then(function(x) {
        ...
        (x = Ca(e)) ? Y(t, x) : (n("[webFontTest] mesureWebFont() : false"), aa(!0));
      }, function(x) {
    ...
    function aa(l) {
      ...
      (l = Ca(e, N)) ? (n("[webFontTest] testWebFont mesurement success : " + l), t(l)) : sa(N) ? (n("[webFontTest] testWebFont timeout!"), ab ? z() : X ? t(0) : Za !== K ? fa(Za) : zb(fa)) : Y(aa);
    }
    function ta() {
    ...
    function fa(l) {
      ...
      l ? (ab = !0, N = d, n("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), e = e.replace(a, ""), z()) : t(0);
    }
    function z() {
      if (E) {
        for (; E.length;) {
    ...
    Ib = function(l, M, x, O, Q, ba, R) {
      ...
      V(10) ? Y(t, 1) : lb ? Y(t, 0) : !J.fonts || 603 > oa || 11 > Ba ? (n("[webFontTest] No native font loader."), aa(!0)) : (n("[webFontTest] Use Native font loader."), Z(e));
    };
    ...
    B, ma = 4 <= V(2) || 10 <= V(3), g, e, E, f, I, w, N, Aa, ab, W, eb, Ra;
  })();
  (function() {
    Qb = function(z, G, X, U) {
  ...
  (function() {
    ...
    function ta(r, D) {
      ...
      if (h) {
        ...
        var f = a.indexOf(r);
        0 <= f && a.splice(f, 2);
        for (5 > q ? ma(r) : da(r); E = e.shift();) {
          f = 5 > q ? E.innerText : E.data, 2 !== b ? (0 <= f.indexOf("\u2091\u208b") && (f = f.split("\u2091\u208b").join(ac)), 0 <= f.indexOf("\u1d07\u207b") && (f = f.split("\u1d07\u207b").join(ac)), b && (0 <= f.indexOf("\u208b\u2081") && (f = f.split("\u208b\u2081").join(hc)), 0 <= f.indexOf("\u1d47/\u1d04") && (f = f.split("\u1d47/\u1d04").join(nc)), 0 <= f.indexOf("\u1d47/") && (f = f.split("\u1d47/").join(lc)), 0 <= f.indexOf("/\u1d04") && (f = f.split("/\u1d04").join(mc)))) : 0 <= f.indexOf("\u2091\u208b") && 
          (f = f.split("\u2091\u208b").join("\u1d07\u207b")), 0 <= f.indexOf("\u2091") && (f = f.split("\u2091").join(gc)), D ? 5 > q ? E.innerText = f : E.data = f : Ca(f.split("\r\n").join("\n").split("\r").join("\n").split("&yen;").join(kc).split("&lt;").join("<").split("&gt;").join(">").split("&quot;").join($b).split("&amp;").join("&"), E);
        }
      }
    }
    function Ca(r, D) {
      ...
      var e = " area line str cmd fnc syb".split(" "), E = 5 > q || 1 === D.nodeType, f = [], I = "", w, N = -1, Aa, ab, W;
      if (E) {
        if (qa) {
      ...
      for (Aa = r.length; N < Aa; ++N) {
        ...
        if ("\n" !== w) {
          ...
          H ? f.push("<font" + (x ? ' class="' + x + '"' : "") + (l ? ' style="' + l + '"' : "") + ">" + w + "</font>") : E || ca ? wa(D, "font", {"class":x, style:l}, w) : Da(D, "font", {"class":x, style:l}, w);
        } else {
          ab = Q = !1, H ? f.push(w) : E || ca ? Ia(D, w) : Ea(D, w);
        }
      }
      if (E) {
        H ? D.innerHTML = f.join("") : ca && Ra.appendChild(D), qa && za(D, "visibility", eb);
      } else {
        if (H) {
          e = J.createElement("font");
    ...
    tb(function(r) {
      function D(M) {
        ...
        if (x) {
          ...
          f ? wa(M, "div", {style:{left:7 * x + 3 + "px"}}) : (O = Ma(M, "title"), nb(M, "pbTip"), nb(M, "title"), Q = wa(M, "div", {className:"pbTip" + (Q ? "Btm" : ""), style:{width:O.length + ma + "em", left:7 * x - (z ? 0 : 5) + "px"}}, O), Q = wa(Q, "div"), .9 <= S && z && za(Q, "left", "2px"));
        }
      ...
      function da(M, x) {
        ...
        ba = ba.split(" ")[0];
        if (R = ya(R.split(" ")[0])) {
          g && (Q = Q.split("pbChr")[1].split(" ")[0], za(M, "backgroundPosition", ja(Q, 2, eb) + "px " + -24 * (10 - R) + "px")), !x && e && Da(M, "a").appendChild(M);
        }
        O && (R = 10 - R, g && (Fb = {backgroundPosition:ja(O, 2, eb) + "px " + -24 * (10 - R) + "px"}), nb(M, "pbGhst"), N = Da(M, "b", {className:"pbChr" + O + " pbCsr" + ba + " pbAlp" + R, style:Fb}, ea), bc(N));
        bc(M);
      }
      if (r) {
        var ma = 6 > q ? 2 : 0, g = 7.2 > B || .9 > S || Ta, e = 1.1 === S, E = 1.4 > S;
        r = u("SAMP");
        var f = 8 === q, I = Ha, w, N, Aa, ab, W;
        yb && ha(Pa, "pbLCD-AX");
        if (r.length) {
          for (Aa = -1; w = r[++Aa];) {
            if (na(P(w), "pbLCD")) {
