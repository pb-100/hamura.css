  ...
  (function() {
    ...
    if (89 <= S || 89 <= va || pa && 79 <= Qb || D && (D("(forced-colors:none)").matches || D("(forced-colors:active)").matches)) {
      ...
      L = function() {
        ...
        e && (u = "#123456" !== e && "rgb(18,52,86)" !== e, G = f(e) < f(g, !0), Q = f(e) > f(g, !0), ya !== h() && (ya = h(), q("(forced-colors-fallback):" + ya), Y(eb, ya, k)));
      };
      ub(function(f) {
        if (f) {
  ...
  (function() {
    ...
    function U(t) {
      ...
      I.fonts.load(ea).then(function(z) {
        ...
        (z = Fa(Q)) ? W(w, z) : (q("[webFontTest] mesureWebFont() : false"), Y(!0));
      }, function(z) {
    ...
    function Y(t) {
      ...
      (t = Fa(Q, m)) ? (q("[webFontTest] testWebFont mesurement success : " + t), w(t)) : ha(m) ? (q("[webFontTest] testWebFont timeout!"), R ? ia() : ca ? w(0) : db !== J ? ka(db) : Cb(ka)) : W(Y);
    }
    function ra() {
    ...
    function ka(t) {
      ...
      t ? (R = !0, m = ba, q("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), ia()) : w(0);
    }
    function ia() {
      var t, ea;
      if (L) {
    ...
    Kb = function(t, ea, z, E, aa, Ca, za) {
      ...
      V(10) ? W(w, 1) : nb ? W(w, 0) : !I.fonts || 603 > oa || 11 > Ea ? (q("[webFontTest] No native font loader."), Y(!0)) : (q("[webFontTest] Use Native font loader."), U(Q));
    };
