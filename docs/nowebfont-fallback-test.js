...
(function(ab, B, C, qa, I, Wa, jb, Sa) {
  ...
  if ("Nitro" === K) {
    ...
    v = 6, r = n(ma, "NintendoBrowser/"), N = 16, T = n(ma, "AppleWebKit/") || (Lb ? 536 : 534), r || (r = Lb ? 4 : 2, l(ma, "Macintosh;") || l(ma, "Windows NT") && l(ma, "Touch"));
    ...
    v = 10, r = n(c, "PLAYSTATION 3; ") || n(c, "PLAYSTATION 3 "), 0 > wa(r, "4.10") && (N = 27, T = r);
    ...
    N = !Ya && (qa.standalone || (Ha || 12 > r) && kb("webkitFullscreenEnabled", C) || 11 <= r && 13 > r && qa.mediaDevices) ? 17 : 18;
    v = 24;
    T = r;
  } else if (l(c, "Kobo")) {
...
(function(ab, B, C, qa, I, Wa, jb, Sa, Aa, l, Pb, kb, n, J) {
    ...
    fb = function(b) {
      if (N(b)) {
        if (da) {
          ...
          return 5.5 > q && 1 === b.nodeType && (b.style.filter = ""), N(b).removeChild(b), b;
        }
      } else {
  ...
  (function() {
    ...
    function ka(f) {
      ...
      for (; m < y; m += 2) {
        ...
        if (R === this) {
          P = f[m + 1];
          5.5 > q ? (R[g] = P, R[g](e), R[g] = ka) : P.call(R, e);
        } else {
    ...
    if (89 <= S || 89 <= va || pa && 79 <= Qb || D && (D("(forced-colors:none)").matches || D("(forced-colors:active)").matches)) {
      ...
      L = function() {
        ...
        e && (u = "#123456" !== e && "rgb(18,52,86)" !== e, G = f(e) < f(g, !0), Q = f(e) > f(g, !0), ya !== h() && (ya = h(), p("(forced-colors-fallback):" + ya), Y(eb, ya, k)));
      };
      ub(function(f) {
        if (f) {
  ...
  (function() {
    ...
    function U(t) {
      ...
      I.fonts.load(ea).then(function(z) {
        ...
        (z = Fa(Q)) ? X(w, z) : (p("[webFontTest] mesureWebFont() : false"), Y(!0));
      }, function(z) {
    ...
    function Y(t) {
      ...
      (t = Fa(Q, m)) ? (p("[webFontTest] testWebFont mesurement success : " + t), w(t)) : ha(m) ? (p("[webFontTest] testWebFont timeout!"), R ? ia() : ca ? w(0) : db !== J ? ka(db) : Cb(ka)) : X(Y);
    }
    function ra() {
    ...
    function Fa(t, ea) {
      ...
      for (5 > q ? P || (P = ra()) : N(P) || Ua.appendChild(P); Ca = ja[++E];) {
      ...
      !q && z && e && (P.textContent = e, V = P.offsetWidth, P.textContent = g, z = V === P.offsetWidth ? 2 : 1, P.textContent = sa);
      P = fb(P);
    ...
    function ka(t) {
      ...
      t ? (R = !0, m = ba, p("[webFontTest] webFontTest_repeatToTestDataURIedCSSWebFont start!"), ia()) : w(0);
    }
    function ia() {
      var t, ea;
      if (L) {
    ...
    Kb = function(t, ea, z, E, aa, Ca, za) {
      ...
      W(10) ? X(w, 1) : nb ? X(w, 0) : !I.fonts || 603 > oa || 11 > Ea ? (p("[webFontTest] No native font loader."), Y(!0)) : (p("[webFontTest] Use Native font loader."), U(Q));
    };
    var ca = 9 > q, O = 6 > va || A || 530 > oa || 5 > Ea || wa(10), x = "bad_" + hb() + "_", M = 5E3, ba = 500, sa = "mmmmmmmmmmlliiiiiiiii", da = 9 <= va && 18 > va || 3 > Ia || 7 > Ea || oa && 0 >= B.conpare(na, "536.11"), ja = ["monospace", "sans-serif", "serif"], Ra, b, a, d, k, u, G, Q, L, f, e, g, m, y, H, R, P, Z, Oa;
  ...
  (function() {
    ...
    var h = 5E3, w = S && 0 > B.conpare(na, "0.9.1"), U = 11 <= q || lb || 9 <= A && 9.5 > A, ha = 11 > q, Y = 7.2 <= A && 7.5 > A, ra = 9 > S && !w || 19 > va || 4.3 > Ia || 2 > yb || 536 > oa || 6 > Ea || 7 <= A && 9 > A && !Y, Fa = !w && !U && !ha && !Y && !ra, ka = Fa ? function(D, ca, O) {
  ...
  (function() {
    ...
    function Fa(a, d, k, u) {
      ...
      var f = " area line str cmd fnc syb".split(" "), e = 5 > q || 1 === d.nodeType, g = [], m = "", y, H = -1, R, P, Z, Oa, t, ea, z, E, aa, Ca, za;
      if (e) {
        if (Ra) {
