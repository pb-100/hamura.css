...
(function(Ua, y, C, ra, G, Ra, gb, La, ya, k, Kb, hb, p, J) {
  ...
  function c(l) {
    ...
    for (; 1 < ca;) {
      Z = W[--ca];
      W[ca] = Z.charAt(0).toUpperCase() + Z.substr(1);
    }
    return B[l] = W.join("");
  }
  function ha(l, B, W) {
  ...
  fb, Zb, jc, ec, fc, $b, gc, kc, lc, mc, hc, nb, ob, Wa, Jb, ac, ic, Xa;
  ...
  (function() {
    ...
    F = function(b, a, d, h, t) {
      a = Z(2, b, a, d, h, t);
      oa || (b.appendChild(a), Fa && null != h && (5.5 > r ? na(a, h) : xa(a, h)));
      return a;
    };
    sb = function(b, a, d, h, t) {
      a = Z(0, b, a, d, h, t);
      oa || (ca(b).insertBefore(a, b), Fa && null != h && (5.5 > r ? na(a, h) : xa(a, h)));
      return a;
    };
    tb = na;
    Ja = function(b, a) {
  ...
  (function() {
    ...
    if (89 <= P || 89 <= va || ja && 79 <= Lb || E && (E("(forced-colors:none)").matches || E("(forced-colors:active)").matches)) {
      ...
      M = function() {
        ...
        e && (t = "#123456" !== e && "rgb(18,52,86)" !== e, D = f(e) < f(g, !0), T = f(e) > f(g, !0), Ka !== l() && (Ka = l(), Z($a, Ka, h)));
      };
      ub(function(f) {
        if (f) {
  ...
  (function() {
    ...
    function ca(n) {
      n && (m = eb());
      (n = na(t, e)) ? B(n) : (n = e, G.hidden || G.msHidden || G.mozHidden || G.webkitHidden ? (m = eb(), n = !1) : n = n < eb() - m, n ? x ? la() : E ? B(0) : db !== J ? xa(db) : Cb(xa) : V(ca));
    }
    function Z() {
    ...
    function na(n) {
      var ba = 0, K = -1, Q = (X || !1) && [], O, da, aa;
      if (!fa) {
        O = -1;
        v = Z();
        for (fa = []; da = pa[++O];) {
          U(v, "fontFamily", da), fa[O] = v.offsetWidth;
        }
      }
      for (5 > r ? v || (v = Z()) : u(v) || Na.appendChild(v); O = pa[++K];) {
        U(v, "fontFamily", '"' + n + '",' + O);
        aa = v.offsetWidth;
        if (X) {
          Q[K] = aa;
      ...
      if (X && aa === Q[0] && aa === Q[1]) {
        for (ba = 1, K = -1; 0 <= (aa = fa[++K]);) {
          if (aa === Q[0] && aa === Q[1] && aa === Q[2]) {
            ba = 0;
            break;
          }
        }
      }
      !r && ba && M && (v.textContent = M, aa = v.offsetWidth, v.textContent = f, ba = aa === v.offsetWidth ? 2 : 1, v.textContent = I);
      v = ea(v);
      return ba;
    }
    function xa(n) {
    ...
    Hb = function(n, ba, K, Q, O, da, aa) {
      ...
      f = da;
      e = g = aa || L;
      S(10) ? V(B, 1) : pb ? V(B, 0) : !G.fonts || 603 > qa || 11 > Ea ? ca(!0) : W(t);
    };
  ...
  (function() {
    ...
    var l = 5E3, B = P && 0 > y.conpare(ia, "0.9.1"), W = 11 <= r || ib || 9 <= z && 9.5 > z, ca = 11 > r, Z = 7.2 <= z && 7.5 > z, na = 9 > P && !B || 19 > va || 4.3 > Pa || 2 > yb || 536 > qa || 6 > Ea || 7 <= z && 9 > z && !Z, xa = !B && !W && !ca && !Z && !na, la = xa ? function(E, Y, L) {
      E.onload = j;
      E.onerror = function() {
  ...
  lc = fb[126];
  mc = Tb(59648);
  hc = (9 === r || P && 0 <= y.conpare(ia, "1.8.1") || cb) && !Sb;
  nb = [];
  Jb = 7.2 > z ? function() {
    ob = !ob;
  ...
  (function() {
    ...
    function ca() {
      ca = J;
      Hb(W, "PB-100", [1, Xa + "pbFont/woff2.css", 2, Xa + "pbFont/woff.css", 3, Xa + "pbFont/ttf.css", 5, Xa + "pbFont/eot.css", 6, Xa + "pbFont/svg.css"], "js-myIconFont-testCssReady", "\u208b\u2081", gc);
    }
    function Z(a) {
      this.focus();
      a.preventDefault();
    ...
    function na(a, d, h, t) {
      ...
      var f = [], e, g;
      if (l) {
        -1 === w.indexOf(a) && (w.push(a, d, h, l, t), pa && ca && ca());
      } else {
        g = w.indexOf(a);
        0 <= g && w.splice(g, 5);
        I || !Za || h || Va(a, "pbList") && A(a.firstChild, "pbList-fallback-img");
        for (5 > r ? T(a, f) : D(a, f); e = f.shift();) {
          g = 5 > r ? e.innerText : e.data, 2 !== I ? (0 <= g.indexOf("\u2091\u208b") && (g = g.split("\u2091\u208b").join($b)), 0 <= g.indexOf("\u1d07\u207b") && (g = g.split("\u1d07\u207b").join($b)), I && (0 <= g.indexOf("\u208b\u2081") && (g = g.split("\u208b\u2081").join(gc)), 0 <= g.indexOf("\u1d47/\u1d04") && (g = g.split("\u1d47/\u1d04").join(mc)), 0 <= g.indexOf("\u1d47/") && (g = g.split("\u1d47/").join(kc)), 0 <= g.indexOf("/\u1d04") && (g = g.split("/\u1d04").join(lc)))) : 0 <= g.indexOf("\u2091\u208b") && 
          (g = g.split("\u2091\u208b").join("\u1d07\u207b")), 0 <= g.indexOf("\u2091") && (g = g.split("\u2091").join(fc)), !d || !h && Za ? xa(g.split("\r\n").join("\n").split("\r").join("\n").split("&yen;").join(jc).split("&lt;").join("<").split("&gt;").join(">").split("&quot;").join(Zb).split("&amp;").join("&"), e, d, h) : 5 > r ? e.innerText = g : e.data = g;
        }
        t && V(t, a);
      }
    }
    function xa(a, d, h, t) {
      ...
      var f = " area line str cmd fnc syb".split(" "), e = 5 > r || 1 === d.nodeType, g = [], m = "", x, v = -1, N, fa, n, ba, K, Q, O, da, aa, kb, Ya;
      if (e) {
        if (Fa) {
      ...
      for (N = a.length; v < N; ++v) {
        ...
        if ("\n" !== x) {
          if (I || !Za || t) {
            ...
            h || (n = da && "str" === aa ? "pbList-strsp" : O ? "" : !da && aa ? "pbList-" + aa : "");
          } else {
            n = fb.indexOf(x), n = -1 === n ? "" : fb.indexOf(x).toString(16).toUpperCase(), n = (n = 1 === n.length ? "0" + n : n) ? "pbChr" + n : "", n = h ? O || da ? "" : n || "" : da && "str" === aa ? "pbList-strsp" : da || !n ? "" : aa ? (n ? n + " " : "") + "pbList-" + aa : n;
          }
          O = J;
          kb ? (x = 6 <= r && 8 > r ? " " : ec, n = "") : Ya && (P && !Oa || 9.5 > z) ? (Ya && !fa && (ba = 4 - (ya(a.substr(v)) + "").length), 7.5 > z ? O = ma ? "position:relative;top:-4px;left:" + 12 * ba + "px" : {position:"relative", top:"-4px", left:12 * ba + "px"} : O = ma ? "position:relative;left:" + 12 * ba + "px" : {position:"relative", left:12 * ba + "px"}) : da && 7.5 > z && (n = "pbList-strsp");
    ...
    ub(function(a) {
      ...
      function d(K) {
        var Q = mb(K, "pbTip"), O, da;
        if (Q) {
          O = Q.charAt(0);
          da = "_" === O;
          Q = (da ? Q.charAt(2) : O).toUpperCase().charCodeAt(0) - 65;
          f ? F(K, "div", {style:{left:7 * Q + 3 + "px"}}) : (O = mb(K, "title"), Da(K, "pbTip"), Da(K, "title"), da = F(K, "div", {className:"pbTip" + (da ? "Btm" : ""), style:{width:O.length + t + "em", left:7 * Q - (ka ? 0 : 5) + "px"}}, O), da = F(da, "div"), .9 <= P && ka && U(da, "left", "2px"));
        }
        M && 0 <= K.className.indexOf("pbColor") && F(K, "u");
      }
      function h(K, Q) {
        var O = mb(K, "pbGhst"), da = K.className, aa = da.split("pbCsr")[1] || "", kb = da.split("pbAlp")[1] || "", Ya, za;
        if ("CS" === O) {
          Ya = "_";
        } else {
        ...
        aa = aa.split(" ")[0];
        if (kb = ya(kb.split(" ")[0])) {
          D && (da = da.split("pbChr")[1].split(" ")[0], U(K, "backgroundPosition", ha(da, 2, fa) + "px " + -24 * (10 - kb) + "px")), !Q && T && sb(K, "a").appendChild(K);
        }
        O && (kb = 10 - kb, D && (za = {backgroundPosition:ha(O, 2, fa) + "px " + -24 * (10 - kb) + "px"}), Da(K, "pbGhst"), m = sb(K, "b", {className:"pbChr" + O + " pbCsr" + aa + " pbAlp" + kb, style:za}, Ya), ac(m));
        ac(K);
      }
      if (a) {
        t = 6 > r ? 2 : 0;
              ...
              for (g = n.length; N = n[--g];) {
                switch(Ba(N)) {
                  case "A":
                    ...
                    Fb ? wa(N, "href", "javascript:void(0)") : (Ma(N, "click", Z), la.push(N));
                    break;
                  case "B":
                    2 > e && h(N, !1);
                }
    ...
    ub(function(a) {
      if (a) {
        X = Xa + "pbFont/x3mask" + (oa ? ".gecko0.9.1.gif" : ".png");
        a = rb("*");
        for (var d = -1, h, t; h = a[++d];) {
          Va(h, "pbList") ? (t = mb(h, "pbskip"), na(h, 0 <= t.indexOf("prettify"), 0 <= t.indexOf("fallback:img"))) : Va(h, "pbFont") && na(h, !0, !0);
        }
        w.length && ca();
        return !0;
      }
  ...
  ic = G.scripts || rb("script");
  Xa = ic[ic.length - 1].src.split("/");
  --Xa.length;
  (Xa = Xa.join("/")) && (Xa += "/");
